        ...
        if (!accessToken && !refreshToken) {
            ...
            if (decodedAccessToken === TOKEN_EXPIRED) {
                ...
                getConnection((conn) => {
                    ...
                    let checkRefreshTokenParam = [decodedAccessToken.email]
                            ...
                            if (rows.length === 0)
                                ...
                                if (rows[0].member_refresh_token !== req.headers.refresh_token) {
                                    ...
                                    if (decodedRefreshToken === TOKEN_EXPIRED) {
                                        ...
                                        let deleteRefreshTokenParam = [decodedAccessToken.email]
                                        ...
                                        jwt.sign(user).then(result => {
                                            ...
                                            let insertNewRefreshTokenParam = [decodedAccessToken.email, newRefreshToken]
